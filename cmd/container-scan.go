...
func initialize() {
	...
	// We want to create the corresponding folders for Grype, and Docker Bench Security
	path, err := os.Getwd()
	if err != nil {
		log.Println(err)
	}

	Create_folder(path + "/Grype")
	...
	Copy_file("enablers.json", "./Grype/enablers.json")
